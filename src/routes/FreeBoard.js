          ...
          <ContentContainer>
              <Contents>
                <MainContentContainer>
                    ...
                    <div >
                        <Pagination uid={user} pagination={pagination} setPagination={setPagination} article={article === false ? 0 : article.length-1} setArticle={setArticle} searchBoard={"free-board"} setLoading={setLoading} />
                    </div>
                </MainContentContainer>
